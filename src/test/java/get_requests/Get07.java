...
public class Get07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get07() {
        ...
        List<Object> list = jsonPath.getList("findAll{it.id>190}.id");  // ==> it=item
        // Groovy Java temelli bir programlama dilidir, yukaridaki getList'in parantez ici Groovy language'dir, rest-assured ile birlikte gelir
